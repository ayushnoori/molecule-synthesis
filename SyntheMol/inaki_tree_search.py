...
from chemfunc.molecular_fingerprints import compute_fingerprint, compute_fingerprints
...
def create_model_scoring_fn(model_path: Path,
    ...
    def model_scoring_fn(smiles: str) -> float:
        if fragment_to_model_score is None or smiles not in fragment_to_model_score:
            ...
            model_score = chemprop_model_score * 2 / 3 + admet_ai_score / 3 # Linear combination of scores
        else:
